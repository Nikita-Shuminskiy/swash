    ...
    return (
        <BaseWrapperComponent isKeyboardAwareScrollView={true}>
            <Box paddingX={4} mb={6} mt={3} flex={1} justifyContent={'space-between'}>
                ...
                <Box>
                    <Text mb={4} fontFamily={'regular'} fontSize={15}>Our goal is to make the process of washing and
                        ironing
                        clothes as simple and affordable as
                        possible.</Text>

                    <Text mb={4} fontFamily={'regular'} fontSize={15}>We understand that modern life is very busy, and
                        many people
                        do not have time to do everyday household
                        chores, such as washing and ironing. That's why we developed this app to help you optimize your
                        time and
                        make this process easier.</Text>

                    <Text mb={4} fontFamily={'regular'} fontSize={15}>With our app, you can order laundry services in a
                        few
                        clicks. Just select the date and time when it is
                        convenient for you to transfer the laundry, and our experienced workers will pick it up from
                        you. After your
                        laundry is thoroughly washed and neatly ironed, it will be delivered back to you at the
                        specified time and
                        place.</Text>

                    <Text mb={6} fontFamily={'regular'} fontSize={15}>We have thought through every detail to provide
                        you with
