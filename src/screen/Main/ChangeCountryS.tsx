    ...
    return (
        <BaseWrapperComponent>
            <Box paddingX={4} mb={6} mt={3} flex={1}>
                ...
                <Box mt={4}>
                    <Text fontSize={15} fontFamily={'regular'}
                          color={colors.grayLight}>{dictionary[DictionaryEnum.YouCanAlwaysChangeCountryInYourProfile]}</Text>
                    <Box mt={4} mb={4}>
            ...
            </Box>
            {
                ...
                <CountriesPopUp text={dictionary[DictionaryEnum.ChoiceOfCountries]} saveCountry={setSelectedCountry}
